...
SENSORS: Dict[int, Sensor] = {
    SENSOR_AWAY_MODE: Sensor("away_mode", None, 16, TYPE_CN_UINT8),
    SENSOR_CHANGING_FILTERS: Sensor("changing_filters", None, 18, TYPE_CN_UINT8),  # 1 when active, 2 when changing filters
    33: Sensor("sensor_33", None, 33, TYPE_CN_UINT8),
    37: Sensor("sensor_37", None, 37, TYPE_CN_UINT8),
    SENSOR_OPERATING_MODE_BIS: Sensor("operating_mode_bis", None, 49, TYPE_CN_UINT8),
    53: Sensor("sensor_53", None, 53, TYPE_CN_UINT8),
    54: Sensor("sensor_54", None, 54, TYPE_CN_UINT8),
    55: Sensor("sensor_55", None, 55, TYPE_CN_UINT8),
    ...
    SENSOR_BYPASS_OVERRIDE: Sensor("Bypass Override", None, 338, TYPE_CN_UINT32),  # 2 when overriden, 0 when auto
    341: Sensor("sensor_341", None, 341, TYPE_CN_UINT32),
    342: Sensor("sensor_342", None, 342, TYPE_CN_UINT32),
    343: Sensor("sensor_343", None, 343, TYPE_CN_UINT32),
    369: Sensor("sensor_369", None, 369, TYPE_CN_UINT8),
    370: Sensor("sensor_370", None, 370, TYPE_CN_UINT8),
    371: Sensor("sensor_371", None, 371, TYPE_CN_UINT8),
    372: Sensor("sensor_372", None, 372, TYPE_CN_UINT8),
